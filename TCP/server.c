...
void chat(int sockfd, Client* Marcel) {
	char buff[MAX];
	int n;
...
int main() {
	...
	if (listen(sockfd, 5) != 0) {
		printf("Le serveur n'est pas en attente : échec\n");
		return 0;
	}
	...
	if (connfd < 0) {
		printf("Le serveur n'a pas pu accepter le client...\n");
		return 0;
	}

	printf("Le serveur a accepté le client ! La communication peut commencer.\n\n");
